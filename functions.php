...
<?php
    ...
    function signup($fullname,$name,$email,$password,$phone,$repassword,$conn){
        $hashedPassword = encryption($password);

        $query = mysqli_query($conn,"INSERT INTO users(fullname, name, email, phone, password) VALUES('$fullname','$name','$email','$phone','$hashedPassword')");
        ...
        if($query){
            ...
            echo "Query Error : " . "INSERT INTO users(fullname, name, email, phone, password) VALUES('$fullname','$name','$email','$phone','$hashedPassword')" . "<br>" . mysqli_error($conn);
            echo "<br>";
